...
class ImageAdapter(_imageItems: List<ImageItem>, _callback: (ImageItem)->Unit) : RecyclerView.Adapter<ImageAdapter.ImageItemViewHolder>()
{
    ...
    inner class ImageItemViewHolder(layout : View) : RecyclerView.ViewHolder(layout){
        val imageView = layout.findViewById<ImageView>(R.id.displayImageView)
        val textView = layout.findViewById<TextView>(R.id.nameTextView)
